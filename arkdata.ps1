...
Function Run-ARKDataTask {
	...
	$ARKDataBinDir
	while ($true) {
		$ARKDataBinDir = "C:\Dropbox\repos\ARKData"
...
Function Out-ARKDataTribeDB {
	...
	foreach ($player in $players) {
		...
		if ($playerdata."Steam name".length -le 0 ) { #write-host $player.name } } 
			...
			$addplayer = $addplayer | Add-Member @{"ARK name"="$playername ???"} -passthru
...
<link rel="stylesheet" type="text/css" charset="utf-8" href="http://gilgamech.com/gilgamech.css">
<link rel="stylesheet" type="text/css" charset="utf-8" href="http://gilgamech.com/ark/ARKData.css">
<link rel="stylesheet" type="text/css" charset="utf-8" href="http://gilgamech.com/ark/ARKDatam.css" media="handheld" />
...
<nav>
    <a href="http://gilgamech.com/">Home</a> |
	<a href="http://gilgamech.com/ark/index.html">ARKData!</a> | 
</nav>
<div class="content">
